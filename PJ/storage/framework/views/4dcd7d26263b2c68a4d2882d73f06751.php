        ...
        <div class="row">
            <form action="<?php echo e(url('/admin/save_category')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control form-control-sm" id="Category_Name" placeholder="Category Name" name="Name">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tn018\Downloads\aptech-k21\aptech-k1\PJ\resources\views/Admin/Create/createCategory.blade.php ENDPATH**/ ?>
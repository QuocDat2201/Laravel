...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="edit-form">
                <form method="post" action="<?php echo e(url('/save')); ?>/<?php echo e($user[0]->id); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="current_photo" value="<?php echo e($user[0]->photo); ?>">
                        </td>
                    </tr>
                </form>
            </div>
...
<?php echo $__env->make('user.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\QUOC DAT\Desktop\aptech-k1\Laravel\PJ\resources\views//user/dashboard/edit.blade.php ENDPATH**/ ?>
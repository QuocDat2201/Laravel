        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="contact__form">
                    <form action="<?php echo e('/send'); ?>" method="post">
                        <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-12"><?php echo $__env->yieldContent('abc'); ?></div>
                            </div>
                        <div class="row">
                            <div class="col-md-5">
...
<?php echo $__env->make('user.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\QUOC DAT\Desktop\aptech-k1\Laravel\PJ\resources\views/user/dashboard/contacts.blade.php ENDPATH**/ ?>
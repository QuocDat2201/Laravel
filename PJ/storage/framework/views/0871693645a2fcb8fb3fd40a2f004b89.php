        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-12">
                <div class="blog__details__pic">
                    <img src=" <?php echo e(asset('admin')); ?>/img/blog/details/blog-details.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-8">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="blog__details__author">
                                    <div class="blog__details__author__pic">
                                        <img src=" <?php echo e(asset('admin')); ?>/img/blog/details/blog-author.jpg" alt="">
                                    </div>
...
<?php echo $__env->make('user.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tn018\Desktop\New folder\aptech-k1\PJ\resources\views/user/pages/blogdetails.blade.php ENDPATH**/ ?>
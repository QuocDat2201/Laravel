            ...
            <div class="col-lg-6 col-md-6">
                <nav class="header__menu mobile-menu">
                    <ul>
                        ...
                        <li class="active"><a href="<?php echo e(url('/admin/dashboard/contacts')); ?>">Contacts</a></li>
                    </ul>
                </nav>
            </div>
            <div class="col-lg-3 col-md-3">
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\QuocHi\OneDrive\Máy tính\Project\Project\Project\resources\views/admin/dashboard/contacts.blade.php ENDPATH**/ ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo e($orders->user_name); ?></td>
                                        <td><?php echo e($orders->user_phone); ?></td>
                                        <td><?php echo e($orders->user_email); ?></td>
                                        <td><?php echo e($orders->user_address); ?></td>
                                        <td><?php echo e($orders->payment); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($order_prod->quantity); ?></td>
                                            <td><?php echo e($order_prod->product_price); ?>$</td>
                                            <td><?php echo e($order_prod->quantity * $order_prod->product_price); ?>$</td>
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php $__currentLoopData = $order_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php 
                                                    $sum += ($order_prod->quantity * $order_prod->product_price);
                                                ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo e($sum); ?>$
                                        </td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\QUOC DAT\Desktop\aptech-k1\PJ\resources\views/Admin/MainPage/order_details.blade.php ENDPATH**/ ?>
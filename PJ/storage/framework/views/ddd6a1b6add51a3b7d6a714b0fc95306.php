                    ...
                    <div class="col-md-3">
                        <div class="mylogo">
                            <a href="<?php echo e(url('/')); ?>"><img
                                    src="<?php echo e(asset('user')); ?>/img/logo.png"alt=""></a>
                        </div>
                    </div>
                    <div class="col-md-6">
                            ...
                            <ul style="margin:30px  0px 0px 60px">
                                <li>
                                    <?php if(session()->has('username')): ?>
                                        <a style="color:black;display:block" href="<?php echo e(url('/account')); ?>"><i
                                                style="font-size: 25px;" class="fa fa-user-circle-o"
                                                aria-hidden="true"></i>
                                    ...
                                    <?php else: ?>
                                        <a style="color:black;display:block" href="<?php echo e(url('login/signin')); ?>"><i
                                                style="font-size: 25px;" class="fa fa-user-circle-o"
                                                aria-hidden="true"></i>
                                        </a>Sign in
                                    <?php endif; ?>
...
<?php /**PATH C:\Users\tn018\Downloads\aptech-k21\aptech-k1\PJ\resources\views/user/layout/layout.blade.php ENDPATH**/ ?>
        ...
        <div class="row">
            ...
            <div class=" col-md-5">
                <div style="" align="center">
                    ...
                    <a href="<?php echo e(url('addorder/' . $product->id)); ?>"><img
                        ...
                        <div class="product__item sale">
                            <div class="product__item__pic set-bg"
                                ...
                                <ul class="product__hover">
                                    ...
                                    <li><a id="cart" href="<?php echo e(url('addorder/' . $item->id)); ?>"><img
...
<?php echo $__env->make('user.dashboard.shop.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tn018\Downloads\aptech-k21\aptech-k1\PJ\resources\views/user/dashboard/shop/shopdetails.blade.php ENDPATH**/ ?>
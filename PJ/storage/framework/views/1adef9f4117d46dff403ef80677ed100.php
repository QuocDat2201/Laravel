                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="mt-3">
                                ...
                                <br>
                                <textarea cols="100" rows="10" id="description" class="form-control" name="Description" ><?php echo e($products->details); ?>
                            ...
                            <div class="mt-3">
                                ...
                                <input type="file" class="form-control" id="galary" name="galary" accept="image/*">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="Category" id="Quantity" class="form-control form-control-sm">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\QUOC DAT\Desktop\aptech-k1\PJ\resources\views/admin/Edit/edit_product.blade.php ENDPATH**/ ?>
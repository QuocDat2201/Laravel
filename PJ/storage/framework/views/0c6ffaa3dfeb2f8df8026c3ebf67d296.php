    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="row">
                ...
                <div class="col-md-8"><img align="center" src="<?php echo e(asset('images/no-images.jpg')); ?>" alt="" style="width: 100px;height:100px; display:block;color: #fff;
...
<?php echo $__env->make('user.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\PJ\resources\views/user/dashboard/info.blade.php ENDPATH**/ ?>
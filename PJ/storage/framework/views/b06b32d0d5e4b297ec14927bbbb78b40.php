            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <div>
                            <a href="<?php echo e(url('/user/dashboard')); ?>"><img style="height:30px"
                    ...
                    <div class="col-lg-2 col-md-2">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <a style="color:black" href="#">Signin</a>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <a style="color:black" href="#">Signin</a>
                            </div>
                    ...
                    <div class="col-lg-1 col-md-1">
                        <a href="#" style="color:black"><i class="fa fa-shopping-basket"></i></a>
...
<?php /**PATH C:\Users\QuocHi\OneDrive\Máy tính\aptech-k1\PJ\resources\views/user/layout/layout.blade.php ENDPATH**/ ?>